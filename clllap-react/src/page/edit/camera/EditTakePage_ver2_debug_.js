...
export default function EditTakePage() {
    ...
    const [takelist,setTakelist] = useState([{uri:"https://clllap.s3.ap-northeast-2.amazonaws.com/clllap/originalvideo00gJ5d0nBkjEnA9qoeFttake4.mp4",duration:70},{uri:"https://clllap.s3.ap-northeast-2.amazonaws.com/clllap/originalvideo00gJ5d0nBkjEnA9qoeFttake4.mp4",duration:8},{uri:"https://clllap.s3.ap-northeast-2.amazonaws.com/clllap/originalvideo00gJ5d0nBkjEnA9qoeFttake4.mp4",duration:22},{uri:"https://clllap.s3.ap-northeast-2.amazonaws.com/clllap/originalvideo00gJ5d0nBkjEnA9qoeFttake4.mp4",duration:30},{uri:"https://clllap.s3.ap-northeast-2.amazonaws.com/clllap/originalvideo00gJ5d0nBkjEnA9qoeFttake4.mp4",duration:7}]);
...
const PlaystatusArea = styled.div`
    width:100%;height:100%;position:absolute;background-color:rgba(0,0,0,0);left:0;top:0;
`
...
const TimeGrid = styled.div`
    width:calc(100vw*(352/428) / 30);border-left:calc(100vw * (1/360)) solid #fedf20;border-right:calc(100vw * (1/360)) solid #fedf20;height:100%;color:white;display:flex;flex-flow:row wrap;align-items:flex-start;justify-content:center;font-size:8px;position:absolute;
`
const TimeGridOver = styled(TimeGrid)`
    border-left:calc(100vw * (1/360)) solid #0020ef;border-right:calc(100vw * (1/360)) solid #0020ef;
`
