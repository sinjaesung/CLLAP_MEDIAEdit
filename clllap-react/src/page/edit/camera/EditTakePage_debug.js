...
export default function EditTakePage() {
    ...
    const [takelist,setTakelist] = useState([{uri:"https://clllap.s3.ap-northeast-2.amazonaws.com/clllap/originalvideo00gJ5d0nBkjEnA9qoeFttake4.mp4",duration:26}]);
...
const EditTakeWrap = styled.div`
    background: transparent;background-color:rgba(200,180,50,0);
    position:relative;
`
...
const TimelineScrollbar_right= styled.div`
    position:absolute;width:calc(100vw* (40/428));height:100%;right:0;top:0%;
    background-color:rgba(255,255,255,0.5);z-index:7;display:flex;
    flex-flow:column nowrap; justify-content:space-around;align-items:center;
`
...
const TimeGrid = styled.div`
    width:calc(100% / 30);border-left:calc(100vw * (0/360)) solid #fedf20;border-right:calc(100vw * (0/360)) solid #fedf20;height:100%;color:white;display:flex;flex-flow:row wrap;align-items:flex-start;justify-content:center;font-size:8px;
`
