...
export default function GalleryBottomVideoList({onClickActive,onPressEvent, videoList}){
  ...
  function renderItem(item){
    console.log('gallerBottomvidoeList imagess:',item);
    return (
      <TouchableOpacity style={styles.takeItem} onLongPress={()=>{openModal(item)}}onPress={()=>{deleteEvent(item)}} >
            <Image
                style={styles.item}
