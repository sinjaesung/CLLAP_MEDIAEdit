...
export default class HttpsTab extends React.Component {
    ...
    runGetMediaInformation = () => {
        console.log('runGetMediaInformationss:',getMediaInformation);
        this.clearLog();
        ...
        getMediaInformation(testUrl).then((information) => {
            console.log('미디어정보 조회:',testUrl,information);
            console.log('information.mediaPropertiesss:',information.getMediaProperties());
            console.log('information get Streamsss:',information.getStreams());
