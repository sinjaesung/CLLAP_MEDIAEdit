...
export default class AudioTab extends React.Component {
    ...
    logCallback = (log) => {
        console.log('audioTab logCallbakcsss:',log);
    ...
    encodeAudio = () => {
        ...
        executeFFmpegAsync(ffmpegCommand, async(completedExecution) => {
                ...
                if (completedExecution.returnCode === 0) {
                    ...
                    console.log('encoding result datasss:',audioOutputFile);
                    let results=await CameraRoll.save(audioOutputFile);
                    console.log('audio process output result filess: save filesPath',results);
                } else {
