...
const opencvfunction= {
    ...
    laplacian: function laplacian(src) {
    ...
    contours : function contours(src) {
        ...
        let dstc3 = cv.Mat.ones(1280,720,cv.CV_8UC3);
    ...
    transition_Rotation_rightsimple: function transition_Rotation_rightsimple(mat, mat2){
        let transition = [];
        let N1 = mat.cols;
        let M1 = mat.rows;
        transition[0] = new cv.Mat();
    ...
    transition_Rotation_leftsimple:
    //Rotation left
    ...
    transition_flat_diagonal_simple:
    function transition_flat_diagonal_simple(mat, mat2){
        ...
        x1.delete();x2.delete();x3.delete();x4.delete();
        return transition;
    },
    ...
    transition_glitch_noise_simple:
    //글리치 하면서 노이즈 발생  pref
    ...
    function transition_glitch_simple(mat, mat2){
        ...
        for(let T=1;T<13;T++){
            ...
            rgba.delete();mer.delete();dst.delete();rt.delete();gt.delete();bt.delete();
            x1.delete();x2.delete();x3.delete();x4.delete();y1.delete();y2.delete();y3.delete();y4.delete();
        }
